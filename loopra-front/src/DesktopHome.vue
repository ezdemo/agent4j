...
.desktop-home-heading { min-height: 32px; display: flex; align-items: center; justify-content: space-between; margin-bottom: 4px; color: var(--fg, #27272a); font-size: 14px; font-weight: 600; flex: 0 0 auto; }.desktop-home-heading > span { min-width: 0; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }
...
.desktop-heading-actions .desktop-new-session { display: inline-flex; align-items: center; gap: 6px; height: 40px; padding: 0 18px; border-radius: 8px; background: var(--accent-btn, #52525b); color: #fff; font-size: 14px; font-weight: 500; box-shadow: none; transition: background-color var(--t), color var(--t); }.desktop-heading-actions .desktop-new-session:hover { background: var(--blue-dark, #3f3f46); color: #fff; }.desktop-heading-actions .desktop-new-session:active { background: var(--blue-dark, #3f3f46); }.desktop-heading-actions .desktop-new-session svg { width: 14px; height: 14px; }
