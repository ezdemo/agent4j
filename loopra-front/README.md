...
Loopra Frontend 是 Loopra Java AI Agent 框架的前端界面，采用现代化的企业级设计，提供流畅的用户体验和强大的功能。
...
确保 Loopra 后端服务运行在 `http://localhost:8097`。
...
- 问题反馈: https://gitee.com/ezdemo/loopra/issues
