...
/**
 * ACP 协议引导程序 —— 启动 ACP Agent 传输层并绑定 Agent4j 引擎。
 * <p>
 * 支持两种传输模式：
 * <ul>
...
public class AcpBootstrap implements Closeable {
    ...
    public AcpBootstrap(AcpAgentTransport transport) {
        ...
        Agent4jAcpAgent agent = new Agent4jAcpAgent(sessionManager);
