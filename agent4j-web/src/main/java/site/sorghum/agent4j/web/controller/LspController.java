...
import site.sorghum.agent4j.bin.lsp.LspManageService;
import site.sorghum.agent4j.bin.lsp.LspServerConfig;
import site.sorghum.agent4j.bin.lsp.LspServerDTO;
 ...
 * <p>
 * 接口设计参考 {@code McpController}，适配 agent4j REST API 风格。
 * </p>
 *
 * @author Sorghum
 */
