...
**Loopra** 用纯 Java 17 填补了这个缺口。如果你在 Java 技术栈上做开发，终于有一个能和你的项目栈天然融合的 AI 编码代理了。
...
Loopra 深度适配 DeepSeek 和小米 Mimo 的**前缀缓存**机制：
...
编辑 `~/.loopra/config.json` 填上 API Key：
```json
{
...
- 项目地址：**https://gitee.com/ezdemo/loopra**
- 官网：**http://loopra.sorghum.site**
- 更新日志：[CHANGELOG.md](https://gitee.com/ezdemo/loopra/blob/main/CHANGELOG.md)
...
*本文基于 Loopra v26.6.29 撰写 | MIT 开源 | 作者 Sorghum*
