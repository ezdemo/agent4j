  ...
  <header class="titlebar" @dblclick="toggleMaximize">
    ...
    <div class="titlebar-left">
      ...
      <div class="titlebar-brand">
        <img src="../assets/logo.png" alt="Agent4j Logo" class="titlebar-logo" />
        <span class="titlebar-title">Agent4j <code>workspace</code></span>
      </div>
    </div>

    <!-- 中间：会话标题 -->
    <div class="titlebar-center">
      <span class="titlebar-session">{{ session || 'Start a new task' }}</span>
    </div>
