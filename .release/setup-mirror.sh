#!/bin/bash
#
# Loopra Web Installer (Mirror via Gitee)
# Usage: curl -fsSL https://gitee.com/ezdemo/loopra/releases/download/v26.8.3.1/setup-mirror.sh | bash
#
...
info "Downloading Loopra Web ${VERSION} via Gitee mirror..."
